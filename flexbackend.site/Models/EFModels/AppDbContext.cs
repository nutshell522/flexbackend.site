...
namespace flexbackend.site.Models.EFModels
{
	public partial class AppDbContext : DbContext
	{
		...
		public virtual DbSet<MembershipLevelPrivilege> MembershipLevelPrivileges { get; set; }
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Customized_Shoes>()
				.HasMany(e => e.CustomizedOrders1)
				.WithOptional(e => e.Customized_Shoes1)
				.HasForeignKey(e => e.Customized_Shoes_Id);
			...
			modelBuilder.Entity<logistics_companies>()
				.HasMany(e => e.orders1)
				.WithRequired(e => e.logistics_companies1)
				.HasForeignKey(e => e.logistics_company_Id)
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<Member>()
				.HasMany(e => e.AlternateAddresses1)
			...
			modelBuilder.Entity<MembershipLevel>()
				.HasMany(e => e.MembershipLevelPrivileges)
				.WithRequired(e => e.MembershipLevel)
				.HasForeignKey(e => e.fk_LevelId)
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<order_statuses>()
				.HasMany(e => e.orders1)
				.WithRequired(e => e.order_statuses1)
				.HasForeignKey(e => e.order_status_Id)
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<pay_statuses>()
				.HasMany(e => e.orders1)
				.WithRequired(e => e.pay_statuses1)
				.HasForeignKey(e => e.pay_status_Id)
				.WillCascadeOnDelete(false);

			modelBuilder.Entity<PointCategory>()
				.HasMany(e => e.PointHistories)
				.WithRequired(e => e.PointCategory)
				.HasForeignKey(e => e.fk_PointCategoryId)
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<Privilege>()
				...
				.HasForeignKey(e => e.fk_PrivilegeId)
				.WillCascadeOnDelete(false);

			modelBuilder.Entity<Privilege>()
				.HasMany(e => e.MembershipLevelPrivileges1)
				.WithRequired(e => e.Privilege1)
				.HasForeignKey(e => e.fk_PrivilegeId)
				.WillCascadeOnDelete(false);
			...
			modelBuilder.Entity<ShoesCategory>()
				.HasMany(e => e.Customized_Shoes1)
				.WithOptional(e => e.ShoesCategory1)
				.HasForeignKey(e => e.fk_ShoesCategoryId);
			...
			modelBuilder.Entity<StaffPermission>()
				.HasMany(e => e.Staffs1)
				.WithRequired(e => e.StaffPermission1)
				.HasForeignKey(e => e.fk_PermissionsId)
				.WillCascadeOnDelete(false);
